let playlist = [ {
  'title': 'OOPS | KING, ZAHRAH S KHAN',
  'audio': "assets/sample1.mp3"},
  {'title': 'BIBA (feat. Slick Trick & Toshi)',
    'audio': "assets/sample2.mp3"},
  {'title': 'Birds of Prey X Joker Serena-Safari song',
  'audio': "assets/sample3.mp3"}, 
  {'title': 'Cold Hours | Aleemrk',
    'audio': "assets/sample4.mp3"}, 
  {'title': 'King - Desi Dan Bilzerian | The Gorilla Bounce ',
  'audio': "assets/sample5.mp3"},
  {'title': 'Ami Tomake | MC Headshot',
  'audio': "assets/sample6.mp3"}, 
  {'title': 'Industry Baby × Nagada Sang Dhol🔥 (Sush & Yohan Mashup)',
    'audio': "assets/sample7.mp3"},
  {'title': 'No Competition |Jass Manak, Ft DIVINE, Satti Dhillon',
